                        ...
                        <div class="row left-align card-panel">
                            ...
                            <div class="section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s12 m6 l4">
                                        <input id="rowOfTire" name="rowOfTire" v-model="thisRowOfTire" type="text" class="validate" required>
                                        <label for="rowOfTire">ยางแถวที่ <span class="icon-star">*</span></label>
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="input-field col s12 m6 l4 offset-l2">
                                        <input id="numberOfTire" name="numberOfTire" v-model="thisNumberOfTire" type="text" class="validate" required>
