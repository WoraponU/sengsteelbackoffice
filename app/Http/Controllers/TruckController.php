...
class TruckController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $params = [
			...
			'owner'	=> $request->owner,
			'photo'	=> $request->photo,
			'register_date'	=> $request->has('registerDate') ? date('Y-m-d', strtotime($request->registerDate)) : null,
			'annual_tax_date'	=> $request->has('annualTaxDate') ? date('Y-m-d', strtotime($request->annualTaxDate)) : null,
